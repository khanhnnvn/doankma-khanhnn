...
let Chaincode = class {
  ...
  async Invoke(stub) {
    ...
    try {
      let payload = await method(stub, ret.params, id_user);
  ...
  async queryCar(stub, args, id_user) {
  ...
  async initLedger(stub, args, id_user) {
  ...
  async createCar(stub, args, id_user) {
  ...
  async queryAllCars(stub, args, id_user) {
  ...
  async changeCarOwner(stub, args, id_user) {
